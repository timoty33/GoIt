...
const (
	ConfigProjectFileName = ".goit/config/goit.config.json"
	ConfigPathsFileName   = ".goit/config/goit.config.paths.json"
)
...
func SaveJsonConfigProject(configProject ConfigProject, projectPath string) error {
	...
	encoder.SetIndent("", "  ") // Deixa o JSON fmt.Errorfatado para melhor leitura
